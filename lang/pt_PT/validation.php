...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma contêm as mensagens de erro predefinidas
    | utilizadas pela classe de validação.
    |
    */
    ...
    | utilizando a convenção "atributo.regra" para nomear as linhas.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são utilizadas para substituir o marcador
